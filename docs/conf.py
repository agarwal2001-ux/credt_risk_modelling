...
latex_documents = [
    ('index',
     ...
     u"prem_agarwal_jn24pg167", 'manual'),
]
...
texinfo_documents = [
    ('index', 'project_name', u'project_name Documentation',
     u"prem_agarwal_jn24pg167", 'project_name',
     'This is the first model, done by me,as a credit analyst', 'Miscellaneous'),
]
